...
class HelloApiView(APIView):
    ...
    def post(self, request):
        """Create a hello message with entered name"""
    ...
    def put(self, request, pk=None):
        """Handle updating an object by replacing"""
...
class HabitViewSet(viewsets.ModelViewSet):
    """ Handle creating and updating habits"""
...
class UserProfileFeedViewSet(viewsets.ModelViewSet):
    ...
    def perform_create(self, serializer):
        """Customize behavior of creation from model viewset. Sets use profile to the logged in user"""
